...
/**
 * 蚝油生菜 Oyster Sauce Lettuce — 粤式家常快手菜
 * Day 7 · 青菜素炒主题
 */
export const oysterSauceLettuce: Recipe = {
  ...
  version: "family",
  versionNote:
    "Restaurant version blanches whole heads then plates with sauce; home version uses romaine hearts for easier handling and faster cooking.",
  versionNoteZh:
    "餐厅版整棵白灼后淋汁；家常版用罗马生菜心，更易操作、更快熟。",
  tags: ["quick", "vegetarian", "cantonese", "weeknight"],
  dietary: ["vegetarian"],
  story:
  ...
  storyZh:
    "粤式茶餐厅和家庭餐桌的常客。秘诀是白灼时间刚好保持脆嫩，然后淋上光泽感十足的蚝油汁。这是最快做出餐厅级青菜的方式。",
  ingredients: [
    {
      id: "osl-01",
      ...
      termKey: "lettuce",
      note:
        "Romaine is sturdier than butter lettuce. If unavailable, use bok choy or choy sum.",
  ...
  steps: [
    {
      ...
      textZh:
        "削去生菜底部硬蒂，纵向切成 4 瓣。彻底清洗——泥沙藏在紧密的叶褶里。",
      zhHint: "处理生菜",
      stateNote: {
        visual:
          "Each wedge should be pale green at the base, dark green at the tips, with no brown or wilted outer leaves",
    ...
    },
    {
      ...
      textZh: "大锅盐水烧至滚沸。放入生菜，完全浸没，白灼恰好 30 秒。",
      zhHint: "白灼生菜",
      stateNote: {
        visual:
          "Leaves turn a vivid, glossy bright green and begin to wilt slightly at the edges",
        visualZh: "叶片变成鲜艳有光泽的亮绿色，边缘开始微塌",
        heat: "high",
        timeRef: "30 seconds",
        timeRefZh: "30 秒",
        signal:
          "Color is electric green — if it turns olive, you've overcooked it",
    ...
    },
    {
      ...
      textZh: "原锅（或小平底锅）中火加热食用油。下蒜末爆香 10 秒，不要煎黄。",
      zhHint: "爆香蒜末",
      stateNote: {
