...
const doubanjiang101: BlogPost = {
  ...
  faq: [
    ...
    {
      qEn: "What does doubanjiang taste like?",
      qZh: "豆瓣酱到底是什么味道？",
      aEn: "Salty first, then deeply savory (umami) with a gentle chili warmth and a funky, almost fermented-sweet aroma from the aged fava beans. It is not sharply hot. Think of it as the savory backbone of Sichuan food — the thing that makes mapo tofu taste round rather than flat.",
      aZh: "先咸，后极鲜（umami），带一点温润的辣和陈酿蚕豆那股发酵般的微甜臭香。它不冲辣，更像川味的脊梁——让麻婆豆腐厚重而不是寡淡的那一味。",
    },
    {
      qEn: "Is doubanjiang gluten-free?",
      qZh: "豆瓣酱无麸质吗？",
      aEn: "Usually not. Traditional pixian doubanjiang is brewed from fava beans and chili, but many brands add wheat during fermentation or as a thickener, so they contain gluten. If you need a strict gluten-free version, look for a label that says 无麸质 (gluten-free) or choose a chickpea- or rice-based fermented chili paste and check the ingredients.",
      aZh: "通常含麸质。正宗郫县豆瓣酱用蚕豆和辣椒发酵，但不少牌子会加小麦或面粉增稠，所以含麸质。要严格无麸质，认准包装上的「无麸质」标识，或选鹰嘴豆/大米基底的发酵辣椒酱并核对配料表。",
    },
    {
      qEn: "Is doubanjiang vegan and vegetarian?",
      qZh: "豆瓣酱是纯素/素食吗？",
      aEn: "Yes. Standard doubanjiang is made only from fava beans, chili, salt, and water — no animal products — so it is both vegan and vegetarian. Just double-check flavored or premium blends that sometimes add oyster sauce or other seasonings; plain chili bean paste is plant-based.",
      aZh: "是的。标准豆瓣酱只用蚕豆、辣椒、盐和水，无任何动物成分，纯素也素食。只需留意少数加了蚝油等调味的高端混合款；纯辣椒豆瓣酱是植物性的。",
    },
    {
      qEn: "Can I make doubanjiang at home?",
      qZh: "豆瓣酱能在家自己做吗？",
      aEn: "You can make a quick kitchen version, but true pixian doubanjiang takes months of open-air fermentation and is hard to replicate at home. For a weeknight shortcut, blend chili flakes, fermented black beans, a little soy sauce, and a splash of rice wine into a coarse paste, then fry it in oil before using. It won't have the aged funk, but it gets close enough for stir-fries and mapo tofu.",
      aZh: "家常版能做，但正宗郫县豆瓣酱要露天发酵好几个月，家里很难复刻。快手替代：把辣椒碎、豆豉、一点酱油和少许料酒打成粗酱，用前下油炒香。没有陈酿的臭香，但炒菜和麻婆豆腐够用。",
    },
  ],
};
...
const chineseColdDishes: BlogPost = {
  ...
  categoryEn: "Recipes",
  categoryZh: "凉菜合集",
  tags: ["liang cai", "cold dishes", "appetizer", "banquet", "smashed cucumber", "chinese side dish"],
  authorEn: "HǎoWèi Kitchen",
  authorZh: "好味厨房",
  publishDate: "2026-09-04",
  ...
  bodyEn: [
    ...
    { type: "p", text: "They're practical and strategic. A few can be prepped hours ahead, so the host isn't stuck at the stove when people arrive. More importantly, their acidity and crunch cut through the rich braises and stir-fries that follow — a built-in palate cleanser." },
    { type: "h2", text: "The classics worth knowing" },
    { type: "ul", items: [
      "Smashed cucumber (拍黄瓜): smashed, not sliced, so it holds dressing in every crevice; garlic, vinegar, a little chili oil.",
      "Wood-ear salad (木耳): chewy, crunchy, dressed with vinegar and cilantro — a textural outlier everyone loves.",
      "Cold sesame noodles (凉拌面): springy noodles with a nutty sesame-soy sauce; the ultimate solo lunch.",
      "Century egg with pickled ginger: an acquired taste, but a banquet staple for a reason.",
    ] },
    { type: "note", text: "The through-line is balance: every plate pairs a crunchy or chewy base with a sharp, acidic dressing. Master that and you can cold-dress almost any vegetable." },
    { type: "h2", text: "How to build a cold-dish plate" },
    { type: "ol", items: [
      "Pick one crunchy (cucumber, celery, wood-ear) and one soft (noodles, tofu, egg).",
      "Dress at the last 10 minutes so nothing goes soggy.",
      "Hit salt, acid, and a little fat (sesame oil or chili oil) in every bowl.",
      "Chill the plate, not the flavor — room temperature keeps aromatics alive.",
    ] },
    { type: "h2", text: "For a holiday table" },
    { type: "p", text: "Cold dishes are the easiest win on a Mid-Autumn or Spring Festival spread: make three the morning of, and they're ready when the family sits. Pair them with our festival menus for a complete opener-to-main arc." },
  ],
  bodyZh: [
    { type: "p", text: "走进任何一场中式家宴，桌上最先上的从来不是热菜，而是凉菜。室温端上、提前拌好、客人落座就能动筷——它定调：清爽、酸鲜、咸香，用口感把味蕾叫醒。" },
    { type: "h2", text: "为什么凉菜打头" },
    { type: "p", text: "既实用又讲究。几样可以提前几小时备好，主人不必在客人到时还困在灶台。更重要的是，它的酸和脆能切开后面红烧与炒菜的厚重——自带清口功能。" },
    { type: "h2", text: "值得认识的经典" },
    { type: "ul", items: [
      "拍黄瓜：拍不是切，好让料汁渗进每道缝；蒜、醋、一点辣椒油。",
      "木耳：脆韧口感，配醋和香菜——人人爱的异类质感。",
      "凉拌面：筋道面条配坚果香芝麻酱，是最强单人午餐。",
      "姜汁皮蛋：需要适应，但家宴常客自有道理。",
    ] },
    { type: "note", text: "贯穿原则是一个「平衡」：每盘都拿脆或韧的基底，配一把酸爽的料汁。掌握这点，几乎什么菜都能凉拌。" },
    { type: "h2", text: "怎么拼一盘凉菜" },
    { type: "ol", items: [
      "选一个脆的（黄瓜、芹菜、木耳）和一个软的（面、豆腐、蛋）。",
      "最后十分钟再拌，免得出水变软。",
      "每碗都要有盐、酸和一点脂（香油或辣椒油）。",
      "冷的是盘子不是味道——室温才留得住香气。",
    ] },
    { type: "h2", text: "上节日桌" },
    { type: "p", text: "凉菜是中秋或春节宴最轻松的得分项：当天早上拌三样，家人落座就能上。配我们的节令菜单，开场到主菜一气呵成。" },
  ],
  faq: [
    {
      qEn: "What is liang cai?",
      qZh: "凉菜是什么？",
      aEn: "Liang cai (凉菜) are Chinese dishes served cold or at room temperature, dressed ahead with vinegar, soy, sesame oil, and aromatics. They open banquets and family meals as palate-awakening appetizers.",
      aZh: "凉菜是常温或冷藏端上的中式菜，提前用醋、酱油、香油和香辛料拌好。它们是宴席与家餐的开场，负责唤醒味蕾。",
    },
    {
      qEn: "Can I make cold dishes ahead of time?",
      qZh: "凉菜能提前做吗？",
      aEn: "Yes — that's the point. Most hold well for hours once dressed, and some (like smashed cucumber) actually taste better after 10–20 minutes for the flavors to soak in. Dress noodles and delicate herbs closer to serving.",
      aZh: "能，而且本就该如此。多数拌好能放几小时，拍黄瓜腌 10–20 分钟反而更入味。面条和娇嫩香草临上桌再拌。",
    },
    {
      qEn: "What makes a good cold-dish dressing?",
      qZh: "好吃的凉菜汁怎么调？",
      aEn: "The base is always salt + acid (black or rice vinegar) + a little fat (sesame or chili oil), then aromatics: garlic, ginger, cilantro. Balance those four and almost any vegetable works cold.",
      aZh: "底子是盐 + 酸（陈醋或米醋）+ 一点脂（香油或辣椒油），再加香辛料：蒜、姜、香菜。四样平衡，几乎什么菜凉拌都成。",
    },
  ],
};

const thanksgivingChineseSides: BlogPost = {
  id: "thanksgiving-chinese-side-dishes",
  slug: "thanksgiving-chinese-side-dishes",
  titleEn: "Thanksgiving With a Chinese Twist: 8 Side Dishes That Bridge Both Tables",
  titleZh: "感恩节加点中国味：8 道能连接两张餐桌的中式配菜",
  excerptEn:
    "Hosting Thanksgiving and want something beyond mash? These eight Chinese side dishes pair naturally with roast turkey — familiar enough for guests, exciting enough to feel like a statement.",
  excerptZh:
    "办感恩节大餐，想来点土豆泥之外的？这 8 道中式配菜和烤火鸡天生合拍——客人吃得惯，又足够惊艳。",
  categoryKey: "culture",
  categoryEn: "Holiday",
  categoryZh: "节日",
  tags: ["thanksgiving", "holiday sides", "chinese american", "turkey sides", "fusion", "potluck"],
  authorEn: "HǎoWèi Kitchen",
  authorZh: "好味厨房",
  publishDate: "2026-09-04",
  coverImage: "/images/blog/thanksgiving-chinese-side-dishes.webp",
  relatedRecipeSlugs: ["mapo-tofu", "kung-pao-chicken", "scallion-pancakes", "smashed-cucumber"],
  bodyEn: [
    { type: "p", text: "The American Thanksgiving table is built on sides, which makes it the perfect place to sneak in Chinese flavors. Roast turkey is mild and forgiving — a blank canvas for the savory, sour, and numbing notes Chinese cooking does best. Here are eight that land." },
    { type: "h2", text: "The eight" },
    { type: "ul", items: [
      "Mapo tofu — spicy, silky, the ultimate turkey-matching side; make it mild for kids.",
      "Kung pao green beans — crunchy, sweet-sour, a natural stand-in for a green-bean casserole.",
      "Scallion pancakes — flaky, savory, better than dinner rolls for sopping gravy.",
      "Smashed cucumber salad — the bright acidic counterpoint every heavy plate needs.",
      "Dan dan noodles — a small bowl as a 'stuffing' alternative or late-night bite.",
      "Dry-fried green beans — restaurant-style, holds well on a buffet.",
      "Chinese pickles (榨菜) — a salty crunch alongside the cranberry sauce.",
      "Sesame noodles — cold, make-ahead, the potluck MVP.",
    ] },
    { type: "note", text: "Rule of thumb: balance the rich turkey and mash with one sour/cold dish (cucumber, sesame noodles) and one numbing/spicy one (mapo, kung pao). That contrast is what makes the spread feel intentional, not random." },
    { type: "h2", text: "Make-ahead plan" },
    { type: "ol", items: [
      "Up to 2 days before: smear cucumber, blend sesame sauce, prep aromatics.",
      "Day before: par-cook green beans, make scallion-pancake dough.",
      "Day of: stir-fries take 10–15 minutes each; mapo tofu last so it stays hot.",
    ] },
    { type: "h2", text: "For guests who've never tried this" },
    { type: "p", text: "Lead with the familiar (scallion pancakes, sesame noodles) and let the bold ones (mapo, kung pao) be the conversation piece. Every dish links to a full bilingual recipe with substitution notes for any missing ingredient." },
  ],
  bodyZh: [
    { type: "p", text: "美式感恩节桌面全靠配菜，这恰好是塞进中国味的好地方。烤火鸡温和包容，是咸鲜、酸、麻这些中式长项的空白画布。下面 8 道都站得住。" },
    { type: "h2", text: "八道菜" },
    { type: "ul", items: [
      "麻婆豆腐——辣、嫩，配火鸡的终极小菜，给孩子做微辣版。",
      "宫保四季豆——脆、甜酸，天然替代青豆焗盅。",
      "葱油饼——层次酥香，蘸肉汁比餐包更绝。",
      "拍黄瓜——每盘厚味都需要的那口酸脆。",
      "担担面——小碗当「馅料」替代或深夜零嘴。",
      "干煸四季豆——餐厅级，自助餐上放得住。",
      "榨菜——配蔓越莓酱的咸脆一笔。",
      "芝麻酱凉面——冷藏、提前做，potluck 之王。",
    ] },
    { type: "note", text: "一个原则：用一道酸/凉（黄瓜、芝麻面）和一道麻/辣（麻婆、宫保）去平衡厚重的火鸡和土豆泥。这种反差才让整桌显得用心，而非杂凑。" },
    { type: "h2", text: "提前计划" },
    { type: "ol", items: [
      "提前两天：拍黄瓜、调芝麻酱、备香辛料。",
      "前一天：四季豆预炒、葱油饼和面。",
      "当天：炒菜每道 10–15 分钟，麻婆豆腐最后做保热。",
    ] },
    { type: "h2", text: "给没试过的客人" },
    { type: "p", text: "先从熟悉的（葱油饼、芝麻面）起头，把猛的（麻婆、宫保）留作话题。每道都链到完整双语菜谱，缺什么料都有替代提示。" },
  ],
  faq: [
    {
      qEn: "What Chinese side dishes go with Thanksgiving turkey?",
      qZh: "感恩节火鸡配什么中式配菜？",
      aEn: "Mapo tofu, kung pao green beans, scallion pancakes, and smashed cucumber salad are the safest crowd-pleasers — they balance the rich turkey with spice and acid. Add sesame noodles and dan dan noodles for make-ahead options.",
      aZh: "麻婆豆腐、宫保四季豆、葱油饼、拍黄瓜是最稳妥的受欢迎款——用辣和酸平衡厚重的火鸡。再加芝麻凉面和担担面做提前备好的选择。",
    },
    {
      qEn: "Can I make these ahead for a potluck?",
      qZh: "这些能提前做带去 potluck 吗？",
      aEn: "Yes. Smashed cucumber, sesame noodles, and scallion-pancake dough all hold well. Stir-fries (mapo, kung pao) are best finished within an hour of serving, but the prep can be done days ahead.",
      aZh: "能。拍黄瓜、芝麻凉面、葱油饼面团都能放。炒菜（麻婆、宫保）最好上桌前一小时内出锅，但备料可提前几天。",
    },
    {
      qEn: "How do I make it mild for kids?",
      qZh: "怎么给孩子做微辣版？",
      aEn: "Drop the dried chilies and chili oil from kung pao, use less doubanjiang in mapo tofu, and lean on scallion pancakes and sesame noodles — both are naturally mild and kid-approved.",
      aZh: "宫保去掉干辣椒和辣椒油，麻婆豆腐少放豆瓣酱，主推葱油饼和芝麻凉面——两样本就微辣、孩子接受度高。",
    },
  ],
};
...
const suancaiPickledMustardGreens: BlogPost = {
  id: "suancai-pickled-mustard-greens",
  slug: "suancai-pickled-mustard-greens",
  titleEn: "Suancai and Pickled Mustard Greens: A Home Cook's Guide",
  titleZh: "酸菜与榨菜：从四川到东北的腌菜指南",
  excerptEn:
    "Suancai is the sour, crunchy backbone of Sichuan hot pot and Cantonese congee. Here's what pickled mustard greens are, how the regional versions differ, and how to ferment a jar at home.",
  excerptZh:
    "酸菜是川味火锅和广式生滚粥里那股酸脆的底味。这篇讲清它是什么、各地版本差在哪，以及怎么在家里腌一罐。",
  bodyEn: [
    { type: "p", text: "Suancai, or pickled mustard greens, is one of China's most versatile fermented vegetables. It turns up in Sichuan hot pot, Cantonese congee, and a dozen regional dishes in between, and it is the reason a plain bowl of rice can suddenly taste like a meal. The sour, crunchy flavor comes from a fermentation you can run at home with three ingredients." },
    { type: "h2", text: "What is suancai?" },
    { type: "p", text: "Suancai is made from mustard greens (芥菜) that are salted and left to ferment. The lactic acid bacteria already living on the leaves turn the vegetable's sugars into acid, which is where the tang comes from. Nothing is added to start it. The salt does two jobs at once: it pulls water out of the greens, and it keeps the wrong microbes from taking over while the right ones get going." },
    { type: "h2", text: "The regional versions" },
    { type: "h2", text: "Sichuan suancai (四川酸菜)" },
    { type: "ul", items: [
      "Mustard greens, salt, and sometimes chili",
      "Ferments in 2 to 4 weeks",
      "Shows up in hot pot, noodles, and stir-fries",
      "The dish that made it famous: suancai yu (酸菜鱼)",
    ] },
    { type: "h2", text: "Northeastern suancai (东北酸菜)" },
    { type: "ul", items: [
      "Made from a larger cabbage",
      "Fermented whole in big crocks",
      "Essential to dishes like suancai bai rou (酸菜白肉)",
    ] },
    { type: "h2", text: "Guangdong suancai (广东酸菜)" },
    { type: "ul", items: [
      "Milder and faster to ferment",
      "Used in congee and soups",
      "Often sold already pickled in jars",
    ] },
    { type: "h2", text: "Making suancai at home" },
    { type: "p", text: "The method is short. The waiting is the hard part." },
    { type: "ul", items: [
      "1 kg mustard greens or napa cabbage",
      "30 g non-iodized salt",
      "1 liter clean water",
      "Optional: dried chili, ginger slices, Sichuan peppercorns",
    ] },
    { type: "ol", items: [
      "Wash the greens and air-dry them completely. Water left on the leaves invites mold.",
      "Blanch for 30 seconds, then cool.",
      "Pack tightly into a clean glass jar.",
      "Pour the brine over the greens and make sure they are fully submerged.",
      "Add the aromatics if you are using them.",
      "Weigh the greens down so they stay under the brine.",
      "Ferment at room temperature for 7 to 14 days.",
      "Move to the refrigerator once it tastes as sour as you want.",
    ] },
    { type: "note", text: "The brine is the whole safety net. Greens that float above it spoil; greens under it keep. If you have to, use a clean plate or a sealed bag of water as a weight." },
    { type: "h2", text: "Cooking with suancai" },
    { type: "p", text: "A few rules carry most dishes." },
    { type: "ul", items: [
      "Do not rinse suancai before cooking. The sour brine is the flavor.",
      "Pair it with a fatty meat (pork belly, fish) to balance the acid.",
      "Add it late if you want the crunch to survive the heat.",
    ] },
    { type: "p", text: "Four dishes to start with: suancai yu, fish with pickled greens; suancai fried noodles, a fast weeknight dinner; suancai pork soup, a warming bowl; and suancai fried rice, which is the best thing to do with leftover rice." },
    { type: "h2", text: "Storage and safety" },
    { type: "ul", items: [
      "Keep the greens submerged in brine at all times.",
      "Refrigerate after the first fermentation.",
      "A thin white film on top is kahm yeast and is safe. Green, black, or pink mold is not, and means the batch should go.",
      "Properly stored suancai keeps 3 to 6 months.",
    ] },
    { type: "h2", text: "FAQ" },
    { type: "h2", text: "Can I use regular salt instead of non-iodized salt?" },
    { type: "p", text: "Iodine can slow fermentation. Use pickling salt, or an iodine-free sea salt, for the most reliable results." },
    { type: "h2", text: "How do I know when suancai is ready?" },
    { type: "p", text: "Taste it after 7 days. When the sourness is where you want it, move the jar to the refrigerator to slow fermentation down." },
    { type: "h2", text: "Is the white film on top safe?" },
    { type: "p", text: "A thin white film is normal kahm yeast and is harmless. Colorful mold is spoilage, and the whole batch should be discarded." },
    { type: "p", text: "For more on fermented and pantry ingredients, browse the ingredient guides on HǎoWèi (好味), or start with /recipes/suan-cai-yu-hot-sour-fish-stew and /recipes/pickled-mustard-green-pork-shreds. If you want to understand the fermentation family next, read /blog/doubanjiang-101." },
  ],
  bodyZh: [
    { type: "p", text: "酸菜是中国最百搭的发酵蔬菜之一。川味火锅里有它，广式生滚粥里有它，中间还有十几种地方菜都靠它提味；一碗白饭之所以能突然变成一顿饭，往往就是因为它。那股酸脆，来自一种你家用三样东西就能跑起来的发酵。" },
    { type: "h2", text: "酸菜是什么" },
    { type: "p", text: "酸菜是用芥菜加盐腌制发酵而成的。叶片上本来就有的乳酸菌，把蔬菜里的糖分转成酸，酸味就是这么来的，不需要额外加什么去启动。盐同时干两件事：把菜里的水逼出来，并在正确的菌群起来之前，压住不该来的杂菌。" },
    { type: "h2", text: "各地的版本" },
    { type: "h2", text: "四川酸菜" },
    { type: "ul", items: [
      "用芥菜和盐，有时加辣椒",
    ...
    { type: "note", text: "盐水就是全部的安全网。浮在上面的菜会坏，压在下面的不会。需要的话，用一只干净盘子或一袋密封的水当重物。" },
    { type: "h2", text: "酸菜怎么做菜" },
    { type: "p", text: "几条规矩就能撑起大部分菜。" },
    { type: "ul", items: [
      "下锅前不要冲洗酸菜。那点酸卤水就是风味本身。",
      "搭配肥一点的肉（五花肉、鱼）来平衡酸度。",
      "想保住脆度，就晚点下锅。",
    ] },
    { type: "p", text: "先试这四道：酸菜鱼，酸菜配鱼的川菜经典；酸菜炒面，快手的一顿晚饭；酸菜猪肉汤，一碗暖身的；还有酸菜炒饭，剩饭最好的去处。" },
    { type: "h2", text: "储存与安全" },
    { type: "ul", items: [
      "始终让菜浸在盐水里。",
      "首次发酵之后放进冰箱。",
      "表面一层薄薄的白膜是酵母膜，安全。绿色、黑色或粉色的霉则不是，出现就整批丢掉。",
      "储存得当的酸菜可以放 3 到 6 个月。",
    ] },
    { type: "h2", text: "常见问题" },
    { type: "h2", text: "能用普通盐代替无碘盐吗？" },
    { type: "p", text: "碘会拖慢发酵。想更稳，用腌菜盐，或者不含碘的海盐。" },
    { type: "h2", text: "怎么知道酸菜好了？" },
    { type: "p", text: "第 7 天尝一下。酸度到位，就把罐子移进冰箱，让发酵慢下来。" },
    { type: "h2", text: "表面那层白膜安全吗？" },
    { type: "p", text: "薄薄一层白膜是正常的酵母膜，无害。彩色的霉是变质，整批都要扔。" },
    { type: "p", text: "想多看些发酵和食材的内容，可以逛好味（HǎoWèi）的食材指南，或先从 /recipes/suan-cai-yu-hot-sour-fish-stew 和 /recipes/pickled-mustard-green-pork-shreds 入手。想接着搞懂整个发酵家族，读 /blog/doubanjiang-101。" },
  ],
  categoryKey: "ingredients",
  categoryEn: "Ingredients",
  categoryZh: "食材",
  tags: ["suancai", "pickled mustard greens", "fermented vegetables", "sichuan", "chinese pantry"],
  authorEn: "HǎoWèi Kitchen",
  authorZh: "好味厨房",
  publishDate: "2026-09-09",
  coverImage: "/images/recipes/suan-cai-yu-hot-sour-fish-stew.webp",
  relatedRecipeSlugs: ["suan-cai-yu-hot-sour-fish-stew", "pickled-mustard-green-pork-shreds"],
  faq: [
    {
      qEn: "Can I use regular salt instead of non-iodized salt?",
      qZh: "能用普通盐代替无碘盐吗？",
      aEn: "Iodine can slow fermentation. Use pickling salt, or an iodine-free sea salt, for the most reliable results.",
      aZh: "碘会拖慢发酵。想更稳，用腌菜盐，或者不含碘的海盐。",
    },
    {
      qEn: "How do I know when suancai is ready?",
      qZh: "怎么知道酸菜好了？",
      aEn: "Taste it after 7 days. When the sourness is where you want it, move the jar to the refrigerator to slow fermentation down.",
      aZh: "第 7 天尝一下。酸度到位，就把罐子移进冰箱，让发酵慢下来。",
    },
    {
      qEn: "Is the white film on top safe?",
      qZh: "表面那层白膜安全吗？",
      aEn: "A thin white film is normal kahm yeast and is harmless. Colorful mold is spoilage, and the whole batch should be discarded.",
      aZh: "薄薄一层白膜是正常的酵母膜，无害。彩色的霉是变质，整批都要扔。",
    },
  ],
};

const lapCheongChineseSausagePrimer: BlogPost = {
  id: "lap-cheong-chinese-sausage-primer",
  slug: "lap-cheong-chinese-sausage-primer",
  titleEn: "Lap Cheong: A Chinese Sausage Primer",
  titleZh: "腊肠入门：一根香肠怎么把米饭变好吃",
  excerptEn:
    "Lap cheong is sweet, salty, and about 30 percent fat, which is exactly why it turns plain rice into a restaurant dish in twenty minutes. Here's what it is, how the regional types differ, and the three easiest ways to cook it.",
  excerptZh:
    "腊肠甜咸交织、脂肪约占三成，正是这一点让普通的米饭二十分钟就能变成餐厅菜。这篇讲清它是什么、各地腊肠差在哪，以及三种最简单的做法。",
  bodyEn: [
    { type: "p", text: "Lap cheong (腊肠) is one of the most useful cured sausages in Chinese cooking. Sweet, salty, and deeply savory, it can turn a pot of plain rice into a restaurant-quality meal in about twenty minutes, mostly by doing nothing except sitting on top of the rice while it steams." },
    { type: "h2", text: "What is lap cheong?" },
    { type: "p", text: "Lap cheong is a cured Chinese sausage made from pork, sometimes beef or duck, along with salt, sugar, soy sauce, and Shaoxing wine. The mixture is stuffed into casings and air-dried for days or weeks. What comes out is firm and concentrated, meant to be sliced thin and cooked fast." },
    { type: "p", text: "Key characteristics:" },
    { type: "ul", items: [
      "Sweet and salty at once",
      "Firm, dry texture",
      "Deep reddish-brown color",
      "Notes of anise and five-spice",
    ] },
    { type: "h2", text: "The regional types" },
    { type: "h2", text: "Cantonese lap cheong (广式腊肠)" },
    { type: "ul", items: [
      "Sweet, with a mild salt level",
      "Made with pork fat, roughly a 30 percent ratio",
      "The most common type outside China",
      "Best for rice dishes and stir-fries",
    ] },
    { type: "h2", text: "Suzhou lap cheong (苏州腊肠)" },
    { type: "ul", items: [
      "Sweeter than the Cantonese style",
      "Thinner casing",
      "Often made with rock sugar",
      "Best for steaming and soups",
    ] },
    { type: "h2", text: "Jinhua lap cheong (金华腊肠)" },
    { type: "ul", items: [
      "From Zhejiang province",
      "Drier and more intense",
      "Common in clay pot rice",
      "Best for congee and clay pot dishes",
    ] },
    { type: "h2", text: "How to cook lap cheong" },
    { type: "h2", text: "Method 1: Steaming (the easiest)" },
    { type: "ol", items: [
      "Slice the sausage diagonally into quarter-inch pieces.",
      "Arrange them on a heat-safe plate.",
      "Steam over rice for the last 15 minutes of cooking.",
      "Let the fat run into the rice. That step is the whole point.",
    ] },
    { type: "h2", text: "Method 2: Pan-frying" },
    { type: "ol", items: [
      "Slice thin.",
      "Heat a teaspoon of oil in a pan over medium heat.",
      "Cook 2 to 3 minutes, until the edges crisp.",
      "Add to stir-fries or noodles.",
    ] },
    { type: "h2", text: "Method 3: Straight into the rice" },
    { type: "ol", items: [
      "Lay whole sausages on top of the rice.",
      "Cook together. The steam does the work.",
      "Slice and serve with the rice.",
    ] },
    { type: "h2", text: "Classic pairings" },
    { type: "ul", items: [
      "Lap cheong rice (腊肠饭): steam sliced sausage with the rice",
      "Clay pot rice (煲仔饭): layer on top and let the bottom crisp",
      "Fried rice (腊肠炒饭): dice and stir-fry with the rice",
      "Congee (腊肠粥): slice thin and stir into the porridge",
      "Noodle soup (肠粉面): slice and add to the broth",
    ] },
    { type: "h2", text: "Storage" },
    { type: "ul", items: [
      "Unopened: refrigerate up to 3 months",
      "Opened: wrap tightly, refrigerate, use within 2 weeks",
      "Long term: freeze up to 6 months",
      "Never store at room temperature once opened",
    ] },
    { type: "h2", text: "Why it works so well" },
    { type: "p", text: "The fat is the trick. Lap cheong is about 30 percent fat, and that fat renders slowly as it cooks. It carries flavor into whatever is around it, whether that is rice, noodles, or vegetables, and builds a savory-sweet depth that is hard to get any other way. This is also why a little goes a long way: one sausage can season a whole pot." },
    { type: "h2", text: "FAQ" },
    { type: "h2", text: "Do I need to cook lap cheong before eating it?" },
    { type: "p", text: "It is already cured, but it is at its best cooked. Steaming or pan-frying softens the fat and wakes up the flavor." },
    { type: "h2", text: "Can I use it straight from the fridge?" },
    { type: "p", text: "Yes. Slice it cold, since firm sausage cuts more cleanly, then cook it as the recipe says." },
    { type: "h2", text: "What can I use instead of lap cheong?" },
    { type: "p", text: "Chinese cured pork belly or a firm smoked sausage will stand in, though neither brings the same sweetness. Adjust the sugar in the dish if you swap." },
    { type: "p", text: "For more on Chinese cured and pantry ingredients, browse the ingredient guides at haoweirecipes.com, or start with /recipes/lap-cheong-claypot-rice. If you want the roast-meat side of Cantonese cooking next, read /blog/char-siu-siu-mei-cantonese-roast-guide, and for seasoning basics, /blog/light-vs-dark-soy-sauce." },
  ],
  bodyZh: [
    { type: "p", text: "腊肠是中国厨房里最好用的腊味之一。甜咸交织、鲜味很足，把一根放在米上一起蒸，二十分钟就能让一锅白饭变成餐厅级的一餐，而你几乎什么都不用做。" },
    { type: "h2", text: "腊肠是什么" },
    { type: "p", text: "腊肠是用猪肉（有时也用牛肉或鸭肉）加盐、糖、酱油和绍兴酒腌制的香肠。混合后灌进肠衣，风干数天到数周。做出来紧实、味道集中，切片后快速烹饪即可。" },
    { type: "p", text: "主要特点：" },
    { type: "ul", items: [
      "甜咸兼具",
      "紧实偏干的质地",
    ...
    { type: "h2", text: "为什么它这么好用" },
    { type: "p", text: "关键在脂肪。腊肠大约三成是脂肪，烹饪时慢慢融化，把味道带进周围的一切，无论是米饭、面条还是蔬菜，堆出别的做法很难达到的咸甜层次。这也是它用量很省的原因：一根就能给一整锅调味。" },
    { type: "h2", text: "常见问题" },
    { type: "h2", text: "腊肠要煮熟才能吃吗？" },
    { type: "p", text: "它本身已经是腌熟的，但加热后最好吃。蒸或煎能让脂肪化开，味道也被唤起来。" },
    { type: "h2", text: "可以直接从冰箱拿出来用吗？" },
    { type: "p", text: "可以。趁冷切片更好切，切好后照菜谱做就行。" },
    { type: "h2", text: "没有腊肠用什么代替？" },
    { type: "p", text: "中式腊肉或紧实的烟熏香肠可以顶替，但都带不来同样的甜香。替换时记得调整菜里的糖量。" },
    { type: "p", text: "想看更多中式腊味和食材指南，可以逛 haoweirecipes.com，或先从 /recipes/lap-cheong-claypot-rice 开始。想接着看广式烧味，读 /blog/char-siu-siu-mei-cantonese-roast-guide；想先搞懂调味，读 /blog/light-vs-dark-soy-sauce。" },
  ],
  categoryKey: "ingredients",
  categoryEn: "Ingredients",
  categoryZh: "食材",
  tags: ["lap cheong", "chinese sausage", "cured meat", "cantonese", "chinese pantry"],
  authorEn: "HǎoWèi Kitchen",
  authorZh: "好味厨房",
  publishDate: "2026-09-10",
  coverImage: "/images/recipes/lap-cheong-claypot-rice.webp",
  relatedRecipeSlugs: ["lap-cheong-claypot-rice", "clay-pot-rice", "yangzhou-fried-rice"],
  faq: [
    {
      qEn: "Do I need to cook lap cheong before eating it?",
      qZh: "腊肠要煮熟才能吃吗？",
      aEn: "It is already cured, but it is at its best cooked. Steaming or pan-frying softens the fat and wakes up the flavor.",
      aZh: "它本身已经是腌熟的，但加热后最好吃。蒸或煎能让脂肪化开，味道也被唤起来。",
    },
    {
      qEn: "Can I use it straight from the fridge?",
      qZh: "可以直接从冰箱拿出来用吗？",
      aEn: "Yes. Slice it cold, since firm sausage cuts more cleanly, then cook it as the recipe says.",
      aZh: "可以。趁冷切片更好切，切好后照菜谱做就行。",
    },
    {
      qEn: "What can I use instead of lap cheong?",
      qZh: "没有腊肠用什么代替？",
      aEn: "Chinese cured pork belly or a firm smoked sausage will stand in, though neither brings the same sweetness. Adjust the sugar in the dish if you swap.",
      aZh: "中式腊肉或紧实的烟熏香肠可以顶替，但都带不来同样的甜香。替换时记得调整菜里的糖量。",
    },
  ],
};
