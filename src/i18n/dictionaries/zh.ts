...
export const dictZh: Dict = {
  ...
  recipeDetail: {
    ...
    recipeJsonLd: "",
    pairingTitle: "这一餐配什么",
    pairingDesc: "一顿完整的中式晚餐搭配方案——每个角色选一道。",
    pairingMain: "主菜",
    pairingSide: "配菜",
    pairingStaple: "主食",
    pairingSoup: "汤羹",
    ...
    depthMistakes: "这些坑别踩",
    depthMistakesDesc: "新手最容易翻车的点——以及怎么避免。",
    depthVars: "换着花样做",
    depthVarsDesc: "一道菜，三种吃法。",
    swap: "替换",
    ratioLabel: "用量",
    mistakeFix: "解法：",
    authorLabel: "菜谱作者",
  ...
  metadata: {
    ...
    blogTitle: "博客",
    blogDesc:
      "在海外做正宗中餐的窍门、技法与家常故事——备料清单、酱料替换，以及每道菜背后的门道。",
  },
  blog: {
    title: "博客",
    subtitle: "中餐家常的技法、备料笔记，和每道菜背后的故事。",
    publishedOn: "发布于",
    by: "作者",
    relatedRecipes: "相关菜谱",
    backToBlog: "← 返回博客",
